layui.use(['form', 'layer', 'table'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'userName', title: '登录账户', minWidth: 100, align: "center"},
            {field: 'name', title: '用户名称', minWidth: 100, align: 'center'},
            {field: 'age', title: '年龄', align: 'center', minWidth: 100},
            {field: 'sex', title: '性别', align: 'center', minWidth: 100},
            {field: 'qq', title: 'QQ', align: 'center', minWidth: 100},
            {field: 'phone', title: '电话', align: 'center', minWidth: 100},
            {field: 'email', title: '邮箱', align: 'center', minWidth: 100},
            {field: 'rate', title: '支付折扣', align: 'center', minWidth: 100},
            {field: 'amount', title: '账户余额', align: 'center', minWidth: 100},
