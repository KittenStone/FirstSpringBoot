...
public class UserController extends BaseController{
    ...
    @ResponseBody
    public ResultInfo<List<User>> selectListData(User role){
        List<User> list = iUserService.selectList(new EntityWrapper<>(role));
        return new ResultInfo<>(list);
    }


    @RequestMapping("/selectOwnListData")
    @ResponseBody
    public ResultInfo<List<User>> selectOwnListData(User role){
